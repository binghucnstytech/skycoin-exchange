...
export class AppComponent implements OnInit {
    ...
    loadBidList() {
        ...
        this.http.get('/api/v1/orders/bid?coin_pair=bitcoin/skycoin', { headers: headers })
            .map((res) => res.json())
            .subscribe(data => {
                this.bidList = _.sortBy(data, function(o){
                    return o.address;
                });
    ...
    loadAskList() {
        /*var headers = new Headers();
        headers.append('Content-Type', 'application/x-www-form-urlencoded');
        this.http.get('/api/v1/orders/ask', { headers: headers })
            .map((res) => res.json())
            .subscribe(data => {
                this.bidList = _.sortBy(data, function(o){
                    return o.address;
